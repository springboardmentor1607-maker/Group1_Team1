  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" width={size} height={size}>
      <defs>
        ...
        <clipPath id="cc"><circle cx="100" cy="100" r="86"/></clipPath>
      </defs>
      ...
      <g clipPath="url(#cc)">
        ...
        <path d="M13,148 Q50,110 100,120 Q150,110 187,148 L187,190 L13,190 Z" fill="url(#grassG)"/>
        <path d="M86,190 Q91,150 100,120 Q109,150 114,190 Z" fill="url(#roadG)"/>
      ...
      <text fontFamily="'Arial Rounded MT Bold', Arial, sans-serif" fontSize="17" fontWeight="800" fill="#2e7d32" letterSpacing="2.5">
        <textPath href="#la" startOffset="7%">CLEAN STREETS</textPath>
      </text>
      ...
      <div className="auth-panel">
        <div className="auth-panel__inner">
          ...
          <h1 className="auth-panel__title">
            Making Cities <span>Cleaner</span>,<br/>One Report at a Time
          </h1>
        ...
        <div className="auth-card">
          <div className="auth-card__header">
            ...
            <p className="auth-card__subtitle">
              ...
              <button onClick={() => navigate("/signup")} style={{ background:"none", border:"none", color:"var(--auth-primary)", fontWeight:600, cursor:"pointer", padding:0, font:"inherit" }}>Sign up free</button>
            </p>
          </div>

          <div className="auth-social" style={{ marginBottom: 20 }}>
            <button className="auth-social-btn"><span className="auth-social-btn__icon">🌐</span>Google</button>
            <button className="auth-social-btn"><span className="auth-social-btn__icon">📘</span>Facebook</button>
          </div>
          ...
          <form className="auth-form" onSubmit={handleSubmit} style={{ marginTop: 16 }}>
            ...
            <button className="auth-btn" type="submit" disabled={loading}>
              {loading ? (<><span className="auth-btn__spinner"/>Signing in…</>) : "Sign In →"}
            </button>
          </form>
        </div>
      </div>
