  ...
  return (
    ...
    >
      ...
      <text
        ...
        letterSpacing="2.5"
      >
        <textPath href="#csTextArcSC" startOffset="7%">
          CLEAN STREETS
        </textPath>
      </text>
...
function LocationMap({ onLocationSelect, selectedCoords, geocodeQuery }) {
  ...
  const placeMarker = (L, map, icon, lat, lng) => {
    ...
    markerRef.current = L.marker([lat, lng], { icon })
      .addTo(map)
      .bindPopup(
        `<b>📍 Issue Location</b><br/>${lat.toFixed(5)}, ${lng.toFixed(5)}`,
      )
      .openPopup();
  };
      ...
      async (pos) => {
        ...
        if (mapInstanceRef.current && window.L) {
          ...
          placeMarker(
            ...
            mapInstanceRef.current._greenIcon,
            lat,
            lng,
          );
        }
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12, color: "#888", marginTop: 8, marginBottom: 0 }}>
        📍 Click the map or use "My Location" to mark the exact issue spot. The
      ...
      <div className="cs-page">
        ...
        <div className="sc-success-screen">
          <div className="sc-success-card">
            ...
            <p>
              Your complaint has been received and will be reviewed by local
              authorities shortly.
            </p>
            <p className="sc-success-sub">
              You'll be notified of any updates via your dashboard.
            </p>
            {form.lat && form.lng && (
              <p style={{ fontSize: 13, color: "#888", marginTop: 8 }}>
                📍 Pinned at {parseFloat(form.lat).toFixed(4)},{" "}
      ...
      <div className="sc-hero">
        <div className="sc-hero__content">
          ...
          <p className="sc-hero__subtitle">
            Help improve your community by reporting civic issues. Fill in the
            details below and we'll get it to the right authorities.
          </p>
        </div>
      </div>
          ...
          <div className="sc-form-grid">
            ...
            <div className="sc-form-col">
              ...
              <div className="cs-sidebar-card sc-section">
                ...
                <div className="sc-row">
                  <div className="cs-form-group">
                    <label className="cs-label">
                      Issue Title <span className="sc-required">*</span>
                    </label>
                    <input
                      className="cs-input"
                      name="title"
                  ...
                  <div className="cs-form-group">
                    <label className="cs-label">
                      Issue Type <span className="sc-required">*</span>
                    </label>
                ...
                <div className="sc-row">
                  <div className="cs-form-group">
                    <label className="cs-label">
                      Priority Level <span className="sc-required">*</span>
                    </label>
                    <div className="sc-select-wrap">
                      <select
                        className="cs-input cs-select"
                ...
                <div className="cs-form-group" style={{ marginBottom: 0 }}>
                  <label className="cs-label">
                    Description <span className="sc-required">*</span>
                  </label>
                  <textarea
              ...
              {/* Photo Upload card */}
              <div className="cs-sidebar-card sc-section">
                <div className="cs-sidebar-card__title">
                  📷 Photo Evidence{" "}
                  <span className="sc-optional">(Optional)</span>
                </div>
                {!form.photoPreview ? (
                  <label className="sc-dropzone">
                    ...
                    <div className="sc-dropzone-inner">
                      ...
                      <p className="sc-dropzone-text">
                        <strong>Click to upload</strong> or drag and drop
                      </p>
                      <p className="sc-dropzone-hint">
            ...
            <div className="sc-side-col">
              ...
              <div className="cs-health-card sc-tips-card">
                <div className="cs-health-card__label">
              ...
              <div className="cs-sidebar-card sc-section">
                ...
                <div className="sc-steps">
                  <div className="sc-step">
                    <div
                      className="sc-step__num"
                      style={{ background: "#dbeafe", color: "#1d4ed8" }}
                    >
                      1
                    </div>
                    <div className="sc-step__text">
                      Your report is received and logged
                    </div>
                  </div>
                  <div className="sc-step">
                    <div
                    ...
                    <div className="sc-step__text">
                      Authorities review and assign the issue
                    </div>
                  </div>
                  <div className="sc-step">
                    <div
                    ...
                    <div className="sc-step__text">
                      Issue is resolved and you're notified
                    </div>
                  </div>
                </div>
              </div>
