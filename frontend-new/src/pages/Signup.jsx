  ...
  return (
    ...
    >
      ...
      <text
        ...
        letterSpacing="2.5"
      >
        <textPath href="#la2" startOffset="7%">
          CLEAN STREETS
        </textPath>
      </text>
      ...
      <div className="auth-panel">
        <div className="auth-panel__inner">
          ...
          <h1 className="auth-panel__title">
            Be the Change
            <br />
            Your City <span>Needs</span>
          </h1>
          <p className="auth-panel__desc">
            Create your free account and start making a difference. Report
            issues, earn civic badges, and help build a cleaner, safer
            community.
          </p>
          ...
          {success ? (
            <div className="auth-success">
              ...
              <p className="auth-success__msg">
                ...
                Your account has been created. Let's start making your city
                cleaner.
              </p>
              <button
                className="auth-btn"
            ...
            <>
              ...
              <form className="auth-form" onSubmit={handleSubmit}>
                ...
                <div className="auth-group">
                  <label className="auth-label">Location / Zone</label>
                  <div className="auth-input-wrap">
                    <span className="auth-input-icon">📍</span>
                    <input
                      ...
                      type="text"
                      name="location"
                      placeholder="Enter your city (e.g., Durgapur)"
                      value={form.location}
                      onChange={handleChange}
                    />
                  </div>
                    ...
                    <div className="auth-strength">
                      <div className="auth-strength__bars">
                        {[1, 2, 3, 4].map((i) => (
                          <div
                            key={i}
                            className={`auth-strength__bar${strength.score >= i ? ` auth-strength__bar--${strength.color}` : ""}`}
                          />
                        ))}
                      </div>
